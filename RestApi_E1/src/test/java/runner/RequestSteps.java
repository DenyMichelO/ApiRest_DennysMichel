...
public class RequestSteps {
    /*
    meneja expresiones cucumbre y sin 5
    1.- la {} se puede ingresar cualquier valor
    2.- {word} solo enviar una palabra
    3.- {string} varias palabras en " word word word"
    4.- {int} datos numericos
    5.- {float} datos x.xx
    */
    ...
    public void queUsoElTokenEnTodoLy() {
        response = given()
                    .auth()
                    .preemptive()
                    .basic("denymichel@ucb.edu.com","1025")
                    .log().all()
                .when()
    ...
    @When("envio un POST {string} con body")
    ...
    @When("envio un PUT {string} con body")
    ...
    @When("envio un DELETE {string} con body")
